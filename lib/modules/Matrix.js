	...
	return function Matrix() {
        ...
        */
        ...
        self.buildOrthographic = function buildOrthographic(near, far, top, bottom, right, left) {
            // This is exactly the openGL glOrtho matrix
        ...
        self.buildFrustum = function buildFrustum(near, far, top, bottom, right, left) {
            // This is exactly the openGL glFrustum matrix
            var frust = new Matrix([
        ...
        self.buildPerspective = function buildPerspective(fovy, aspect, zNear, zFar) {
            // This is exactly the openGL gluPerspective matrix
        ...
        self.perspectivize = function perspectivize(fovy, aspect, zNear, zFar) {
            // This is exactly the openGL gluPerspective matrix
            var f = 1 / Math.tan(fovy / 2);
            self.rawData = [
                [f / aspect, 0, 0,                             0],
