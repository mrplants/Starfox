define([], function() {
	...
	return function Matrix() {
        ...
        */
        ...
        self.buildOrthoProjection = function buildOrthoProjection(near, far, top, bottom, right, left) {
        ...
        self.buildPerspectiveProjection = function buildPerspectiveProjection(near, far, top, bottom, right, left) {
        ...
        self.perspectivize = function perspectivize(near, far, top, bottom, right, left) {
            self.rawData = [
                [2.0/(right-left), 0,                0,             -(right+left)/(right-left)],
                [0,                2.0/(top-bottom), 0,             -(top+bottom)/(top-bottom)],
                [0,                0,                -2/(far-near), -(far+near)/(far-near)],
